package com.droidnova.myschedule.utils
...
abstract class swipeToEditCallback (context: Context): ItemTouchHelper.SimpleCallback(0,ItemTouchHelper.RIGHT){
    ...
    private var editIcon = ContextCompat.getDrawable(context, R.drawable.ic_edit_white_24dp)
    private var intrinsicWidth = editIcon!!.intrinsicWidth
    private val intrinsicHeight = editIcon!!.intrinsicHeight
    private val background = ColorDrawable()
    private val backgroundColor = Color.parseColor("#CA4E79")
